...
const methods = new Set(['connect','disconnect','confirmHostKey','remoteList','transfer','cancelTransfer','readFile','writeFile','chmod','runFile','mkdir','rename','terminalInput','terminalBinaryInput','terminalResize','terminalAck','shutdown']);
