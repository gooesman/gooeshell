...
const methods = new Set(['connect','cancelConnect','disconnect','confirmHostKey','remoteList','transfer','cancelTransfer','readFile','writeFile','readTextFile','writeTextFile','chmod','runFile','mkdir','rename','terminalInput','terminalSecretInput','terminalCommandInput','terminalBinaryInput','terminalResize','terminalAck','shutdown']);
