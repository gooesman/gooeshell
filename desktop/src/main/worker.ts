...
const methods = new Set(['connect','cancelConnect','pushSshKey','cancelSshKeyPush','disconnect','confirmHostKey','remoteList','terminalCwd','transfer','cancelTransfer','readFile','writeFile','readTextFile','writeTextFile','chmod','runFile','mkdir','createFile','removeFile','rename','terminalInput','terminalSecretInput','terminalCommandInput','terminalBinaryInput','terminalResize','terminalAck','shutdown']);
