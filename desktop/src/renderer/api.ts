import type {DesktopApi,AppEvent,FileListing,HostProfile,AppSettings} from '../shared/types';
...
const preview:DesktopApi={
 initial:async()=>({profiles:previewProfiles,settings:previewSettings,localHome:'C:\\Users\\developer',version:'界面演示 · 不会连接服务器'}),
 ...
 fonts:async()=>['DejaVu Sans Mono','Cascadia Code','Cascadia Mono','Consolas','JetBrains Mono','Microsoft YaHei','Microsoft YaHei UI','Noto Sans SC','SimSun'],backgroundData:async()=>'',
